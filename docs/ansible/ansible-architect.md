...
Expert reference for Ansible automation: playbook structure, role organization, task design, inventory management, and best practices. Use when reviewing Ansible code, suggesting improvements, or designing new automation workflows.
...
## Reviewing or Creating Ansible Code

### 1. Structure Analysis

Evaluate the organization against Ansible best practices:
...
Always suggest improvements in these areas:
...
When providing recommendations, structure the response as:
